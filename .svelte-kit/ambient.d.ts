...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_tonal: string;
	...
	export const npm_package_browserslist_1: string;
	export const LOGNAME: string;
	export const LESS: string;
	export const CONDA_PYTHON_EXE: string;
	export const npm_package_scripts_format: string;
	export const npm_package_browserslist_0: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		_CE_M: string;
		npm_package_dependencies_tonal: string;
		...
		npm_package_browserslist_1: string;
		LOGNAME: string;
		LESS: string;
		CONDA_PYTHON_EXE: string;
		npm_package_scripts_format: string;
		npm_package_browserslist_0: string;
